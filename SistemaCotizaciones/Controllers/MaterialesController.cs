...
namespace SistemaCotizaciones.Controllers
{
    public class MaterialesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaterialId,Nombre,Descripcion,Sku,NumeroSerie,CodigoImpulse,PrecioUnitario")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaterialId,Nombre,Descripcion,Sku,NumeroSerie,CodigoImpulse,PrecioUnitario")] Material material)
        {
